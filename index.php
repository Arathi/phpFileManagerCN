...
function et($tag){
    ...
    $cn['InvalidDest'] = '非法的目标目录';
    $cn['NoNewPerm'] = '未设置新的权限';
    $cn['CopyTo'] = '复制到';
    $cn['MoveTo'] = '移动到';
    $cn['AlterPermTo'] = '将权限改为';
    $cn['ConfExec'] = '确认执行';
    $cn['ConfRem'] = '确认删除';
    $cn['EmptyDir'] = '空目录';
    $cn['IOError'] = 'I/O 错误';
    ...
    $cn['InvPass'] = '密码错误';
    $cn['ReadDenied'] = '访问被拒绝';
    $cn['FileNotFound'] = '未找到该文件';
    $cn['AutoClose'] = '完成后关闭';
    $cn['OutDocRoot'] = '文件不在根目录中';
    $cn['NoCmd'] = '错误：命令不正确';
    $cn['ConfTrySave'] = '该文件不可写入。\\n请尝试保存在其他地方';
    $cn['ConfSaved'] = '已保存设置';
    $cn['PassSaved'] = '已保存密码';
    $cn['FileDirExists'] = '文件或目录已存在';
    $cn['NoPhpinfo'] = 'phpinfo()被禁用';
    $cn['NoReturn'] = '无返回';
    $cn['FileSent'] = '发送文件';
    $cn['SpaceLimReached'] = '空间限制';
    $cn['InvExt'] = '非法的扩展名';
    $cn['FileNoOverw'] = '无法覆盖该文件';
    $cn['FileOverw'] = '覆盖';
    $cn['FileIgnored'] = '忽略';
    $cn['ChkVer'] = '检查更新';
    $cn['ChkVerAvailable'] = '发现新版本，请点击此处下载!!';
    $cn['ChkVerNotAvailable'] = '目前没有新版本。:(';
    $cn['ChkVerError'] = '连接错误.';
    $cn['Website'] = '站点';
